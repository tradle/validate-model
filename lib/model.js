...
function _validateModel (model) {
  ...
  const { subClassOf, properties, sort, verifiableAspects, customerCanHaveMultiple,
          interfaces, prerequisiteFor, allow } = model
  ...
  if (prerequisiteFor) {
    const pidErr = validateModelId(prerequisiteFor)
